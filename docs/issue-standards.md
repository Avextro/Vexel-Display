...
- Goal: A one sentence purpose of the issue
- Scope: What is included in this issue
- Tasks: Development checklist of steps required to complete issue
- Definition of Completion: Sets requirements that must be passed for issue to be completed

Optional fields:

- Notes: Any further description of the issue
- Out of Scope: Related work not included in this issue
